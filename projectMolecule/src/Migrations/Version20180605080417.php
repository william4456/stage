 ...
 */
class Version20180605080417 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE molecule (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, scientific_name VARCHAR(255) NOT NULL, description TEXT NOT NULL, MoleculeFile_id INT NOT NULL, UNIQUE INDEX UNIQ_F2EF223925C7B4F0 (MoleculeFile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
